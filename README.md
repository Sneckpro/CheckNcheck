...
- **Бюджеты** — лимиты по категориям с прогресс-баром
- **Графики** — круговая диаграмма и сравнение месяцев
- **Почта** — автосканирование email-чеков (IMAP)
...
| `/budget еда 20000` | Установить бюджет |
| `/budgets` | Все бюджеты |
| `/chart` | Круговая диаграмма за месяц |
| `/chart 3` | Сравнение 3 месяцев |
| `/email` | Подключить почту |
| `/email off` | Отключить почту |
| `/email scan 30` | Сканировать за N дней |
